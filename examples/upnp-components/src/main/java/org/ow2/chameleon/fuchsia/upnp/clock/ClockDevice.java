...
package org.ow2.chameleon.fuchsia.upnp.clock;
...
@Component
@Provides (specifications = {UPnPDevice.class, ClockDevice.class})
@Instantiate
public class ClockDevice implements UPnPDevice {

	final private String DEVICE_ID = "uuid:Felix-Clock123456";
    ...
    @ServiceProperty(name=UPnPDevice.UDN,value="uuid:Felix-Clock123456")
    String deviceID;
