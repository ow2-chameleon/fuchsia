...
public class ContentGraph extends HttpServlet {
    ...
    private static final String URL = "/contentGraph";

    public static final String NODE_FUCHSIA = "Fuchsia";
    public static final String NODE_IMPORTER = "Importer";
    public static final String NODE_EXPORTER = "Exporter";
    public static final String NODE_TYPE_IMPORTER = "importer";
    public static final String NODE_TYPE_EXPORTER = "exporter";
    public static final String NODE_TYPE_DECLARATION = "declaration";
    public static final String NODE_TYPE_NATIVE = "native";
    public static final String NODE_TYPE_LINKER = "linker";
