...
public class FileBasedDiscoveryConstants {
    ...
    public static final String FILEBASED_DISCOVERY_IMPORT_PROPERTY_KEY_MONITORED_DIR_KEY ="fuchsia.system.filebased.discovery.directory";
    public static final String FILEBASED_DISCOVERY_IMPORT_PROPERTY_KEY_MONITORED_DIR_VALUE ="load/import";

    public static final String FILEBASED_DISCOVERY_EXPORT_PROPERTY_KEY_MONITORED_DIR_KEY ="fuchsia.system.filebased.discovery.directory";
