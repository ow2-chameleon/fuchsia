...
include::fuchsia-introduction.asciidoc[]

Creating a fuchsia distribution
-------------------------------

include::fuchsia-distribution.asciidoc[]

Advanced, how to instantiate an importer
----------------------------------------

include::create-importer.asciidoc[]

Examples
--------

//include::ex-importer-jax-rs.asciidoc[]
