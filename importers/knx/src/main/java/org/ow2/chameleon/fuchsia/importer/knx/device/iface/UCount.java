...
/**
 * Corresponds to the DPT 5.010
 * @author Jander Nascimento
 */
public interface UCount extends KNXDevice {

    /**
     *
     * @param value, value is a 8bits value, thus it MUST be in the range [0..255]
     * @throws ValueOutOfTheRangeException in case if the value passed is out of the range
     */
