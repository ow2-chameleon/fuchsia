...
import org.ow2.chameleon.fuchsia.importer.zwave.internal.protocol.SerialMessage.SerialMessageClass;
import org.ow2.chameleon.fuchsia.importer.zwave.internal.protocol.SerialMessage.SerialMessagePriority;
import org.ow2.chameleon.fuchsia.importer.zwave.internal.protocol.SerialMessage.SerialMessageType;
import org.ow2.chameleon.fuchsia.importer.zwave.internal.protocol.ZWaveController;
import org.ow2.chameleon.fuchsia.importer.zwave.internal.protocol.ZWaveDeviceClass;
...
/**
 * Handles the Multi Instance / Multi Channel command class. The Multi Instance command class is 
 * used to control multiple instances of the same device class on the node. Multi Channel support
 * (version 2) of the command class can also handle multiple instances of different command 
